...
public class PointCP2Test
{
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("Cartesian-Polar Coordinates Program");
    ...
    try
    {
      point = new PointCP2(args[0].toUpperCase().charAt(0), Double.valueOf(args[0]).doubleValue(),Double.valueOf(args[1]).doubleValue());
    ...
    try
    {
      point2 = new PointCP2(args[0].toUpperCase().charAt(0), Double.valueOf(args[0]).doubleValue(),Double.valueOf(args[1]).doubleValue());
    ...
    System.out.println("\nThe Distance between (Carestian Point) "
    		+ point.convertStorageToCartesian() +"and the (Carestian Point)"
    		+ point2.convertStorageToCartesian() +"is "
    		+ point.getDistance(point2)
    		);
    
    System.out.println("\nNow enter a degree for rotating Polar point " + point.toString()+ "to compute the rotate point in Polar");
    	boolean fl = false;
